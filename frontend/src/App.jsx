...
// THE PRO-GRADE FIX: Re-inserting 'symbol' into the dependency array. 
// This ensures the widget properly updates the stock data on every click.
const TVChart = ({ symbol, theme }) => {
    ...
    const loadChart = () => {
      if (window.TradingView) {
        new window.TradingView.widget({
          ...
          // Auto-injecting the indicators so they don't disappear when the chart reloads!
          studies: [
          ...
          studies_overrides: {
            "MAExp@tv-basicstudies.plot.color": "#f97316", // Both EMAs will be Orange
  ...
  }, [symbol, theme]); // <--- Adding 'symbol' back here fixes the freezing issue.
